...
namespace Sts.Poc.Minimal.Api.Infrastructure.Middleware;
...
public sealed partial class BadHttpRequestToValidationHandler : IExceptionHandler
{
    ...
    /// <summary>
    /// Generates a user-friendly error message based on the parameter type, provided value, and whether the parameter was
    /// missing.
    /// </summary>
